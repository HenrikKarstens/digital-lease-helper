...
import { CreditCard, Zap, Shield, ArrowRight, CheckCircle2, Mail, ExternalLink, Lock } from 'lucide-react';
...
export const Step12Unlock = () => {
  ...
  const estimatedKwh = 2000; // default estimate
    ...
    <div className="min-h-[80vh] flex flex-col items-center px-4 py-8">
      ...
      <div className="w-full max-w-md space-y-4">
        ...
        <motion.button
          ...
          disabled={processing}
          className="w-full rounded-2xl border-2 border-primary/20 hover:border-primary/50 p-5 text-left transition-all hover:shadow-md group disabled:opacity-50"
        >
