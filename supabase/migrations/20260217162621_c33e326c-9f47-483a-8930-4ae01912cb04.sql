...
CREATE TABLE public.projects (
  ...
  title TEXT NOT NULL DEFAULT 'Neue Übergabe',
  address TEXT,
  current_step INTEGER NOT NULL DEFAULT 0 CHECK (current_step >= 0 AND current_step <= 15),
  handover_data JSONB NOT NULL DEFAULT '{}'::jsonb,
